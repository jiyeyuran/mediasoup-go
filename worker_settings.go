...
type WorkerSettings struct {
	...
	// To facilitate testing, this path allows the use of the following pattern:
	// valgrind --tool=memcheck --leak-check=full ./mediasoup-worker
	WorkerBin string

	// WorkerVersion is the version of mediasoup-worker. The default value is 3.9.0
	// which should be compatible with mediasoup-worker versions greater than or
	// equal to 3.9.0. In order to communicate with mediasoup-worker, you must set
	// this value correctly if your mediasoup-worker version is less than 3.9.0.
